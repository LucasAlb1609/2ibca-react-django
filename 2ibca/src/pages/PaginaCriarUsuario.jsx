...
// Componente auxiliar para inputs, para manter o JSX mais limpo
  ...
  return (
    <div>
      ...
      <input
        ...
        id={name}
        name={name}
        value={value || ''} // Usar || '' para evitar avisos de input não controlado
        onChange={onChange}
        disabled={disabled}
...
function PaginaCriarUsuario() {
  ...
  if (user?.papel !== 'secretario') {
    return <div className="text-center p-10 text-red-500 font-semibold italic">Acesso negado. Apenas secretários podem criar usuários.</div>;
  }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-xl overflow-hidden">
            <div className="bg-green-600 text-white p-4">
              <h3 className="text-2xl font-semibold">Criar Novo Usuário</h3>
            </div>
            <div className="p-6 md:p-8">
              <p className="text-gray-600 mb-6">Preencha os dados do novo usuário. A conta será criada como "Aprovada".</p>
              ...
              <form onSubmit={handleSubmit} noValidate encType="multipart/form-data" className="space-y-8">
                ...
                <section className="p-6 bg-gray-50 rounded-lg border">
                  <h4 className="text-lg font-semibold text-gray-700 border-b-2 border-green-500 pb-2 mb-6">Dados de Acesso</h4>
                ...
                <section className="p-6 bg-gray-50 rounded-lg border">
                  <h4 className="text-lg font-semibold text-gray-700 border-b-2 border-green-500 pb-2 mb-6">Dados Pessoais</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <section className="p-6 bg-gray-50 rounded-lg border">
                  <h4 className="text-lg font-semibold text-gray-700 border-b-2 border-green-500 pb-2 mb-6">Família e Saúde</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                  ...
                  <div className="mt-4">
                    <p className="font-bold text-sm">Possui filhos?</p>
                ...
                <section className="p-6 bg-gray-50 rounded-lg border">
                   <h4 className="text-lg font-semibold text-gray-700 border-b-2 border-green-500 pb-2 mb-6">Contato, Endereço e Profissão</h4>
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <section className="p-6 bg-gray-50 rounded-lg border">
                  <h4 className="text-lg font-semibold text-gray-700 border-b-2 border-green-500 pb-2 mb-6">Informações Eclesiásticas</h4>
                ...
                <div className="flex justify-between items-center mt-8">
                  ...
                  <button type="submit" disabled={loading} className="bg-green-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-green-700 transition-colors disabled:bg-gray-400">
